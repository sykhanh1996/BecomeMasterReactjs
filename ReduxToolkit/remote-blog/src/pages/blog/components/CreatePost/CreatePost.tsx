...
export default function CreatePost() {
  ...
  const [errorForm, setErrorForm] = useState<null | ErrorForm>()
    ...
    <form onSubmit={handleSubmit} onReset={handleCancelEditingPost}>
      ...
      <div className='mb-6'>
        <label
         ...
         dark:text-gray-300 ${errorForm?.publishDate ? 'text-red-700' : 'text-gray-900'}`}
        >
          Publish Date
        </label>
        <input
          type='datetime-local'
          id='publishDate'
          className={`block w-56 rounded-lg border  p-2.5 text-sm text-gray-900 
           focus:outline-none ${
             errorForm?.publishDate
               ? 'focus: border-red-500 bg-red-50 text-red-900 placeholder-red-700 ring-red-500 focus:border-red-500'
